...
class E2eKeysHandler:
    ...
    async def query_local_devices(
        ...
        if self._query_appservices_for_keys:
            ...
            appservice_results = await self.appservice_handler.query_keys(query)
    ...
    async def claim_one_time_keys_local(
        ...
        if self._query_appservices_for_otks:
            ...
            (
                appservice_results,
                not_found,
            ) = await self.appservice_handler.claim_e2e_one_time_keys(not_found)
        else:
            appservice_results = []
    ...
    async def claim_one_time_keys(
        ...
        results = await self.claim_one_time_keys_local(local_query)
